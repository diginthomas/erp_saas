...
class PreInstall
{
    ...
    public function init(): void
    {
        ...
        $this->ensureEmptyKeyIsPresent('APP_URL');
    ...
    private function ensureIdentificationKeyIsSetInEnvironmentFile(): void
    {
        ...
        $this->ensureEmptyKeyIsPresent('IDENTIFICATION_KEY');
        ...
        if ($cachedIdentificationKey && ! $envIdentificationKey) {
            ...
            $this->writeIdentificationKeyInEnvironmentFile((string) Str::uuid());
        }
    }
    ...
    private function ensureKeyIsSetInEnvironmentFile(): void
    {
        ...
        $this->ensureEmptyKeyIsPresent('APP_KEY');
     ...
     */
    private function ensureEmptyKeyIsPresent(string $key): void
    {
