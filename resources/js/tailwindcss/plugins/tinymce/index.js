...
export default plugin(function ({ addComponents }) {
  addComponents({
    ...
    // Styling
    '.tox .tox-dropzone': {
      '@apply !bg-neutral-50 dark:!bg-neutral-800 !border-neutral-300 dark:!border-neutral-600':
        {},
    },
    ...
    '.tox': {
      ...
      '.tox-dialog__body-nav-item:focus': {
        '@apply !bg-primary-50/50 dark:!bg-primary-100 dark:!text-primary-700':
          {},
      },

      '.tox-dialog__body-nav-item--active': {
        '@apply !text-primary-600 !border-b-2 !border-primary-600 dark:!text-primary-200':
          {},
      },
