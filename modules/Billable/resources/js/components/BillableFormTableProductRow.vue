<template>
  <tr>
    ...
    >
      <div class="w-44 sm:w-auto">
        <div class="flex rounded-md shadow-sm">
          ...
          <div
            class="-ml-px flex items-center border border-neutral-300 bg-white px-1.5 shadow-sm dark:border-neutral-500 dark:bg-neutral-700"
            v-text="'%'"
          />

          <IPopover placement="bottom" class="max-w-sm">
            <IButton
              size="sm"
              variant="white"
              rounded="right"
      ...
      <div class="relative w-44 rounded-md shadow-sm sm:w-auto">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center">
          <IFormSelect
            ...
            size="sm"
            rounded="right"
            class="bg-transparent bg-none pl-1 pr-2 text-center ring-0 dark:bg-transparent"
    ...
    <td
      class="bg-white px-2 py-4 text-center align-top text-sm font-medium text-neutral-900 dark:bg-neutral-800 dark:text-neutral-100"
    >
