<template>
  <div class="mb-2 mt-4 grid grid-cols-12 gap-2">
    <div
      class="col-span-8 text-sm text-neutral-600 sm:col-span-5 sm:col-start-5 sm:text-right dark:text-neutral-100"
    >
    ...
    <div
      class="col-span-4 text-right text-sm text-neutral-600 sm:col-span-3 dark:text-neutral-100"
  ...
  <div class="grid grid-cols-12 gap-2">
    <div
      ...
      class="col-span-8 text-sm font-semibold text-neutral-900 sm:col-span-5 sm:col-start-5 sm:text-right dark:text-neutral-100"
    />

    <div
      class="col-span-4 text-right text-sm font-medium text-neutral-900 sm:col-span-3 dark:text-neutral-100"
