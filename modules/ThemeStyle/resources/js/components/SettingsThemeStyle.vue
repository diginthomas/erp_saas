<template>
  <form @submit.prevent="saveThemeStyle(colors)">
    <ICard
    ...
    >
      ...
      >
        <div class="mb-2 items-center md:flex">
          <div
            class="flex-grow text-center text-base font-medium text-neutral-800 md:text-left dark:text-neutral-100"
          >
          ...
          <div class="flex items-center justify-center space-x-3">
            <ILink
              ...
              :class="['mr-3', { 'pointer-events-none': resetting }]"
              @click="reset(color)"
            />
            ...
            <div class="relative">
              ...
              <input
                ...
                type="number"
                class="block w-full rounded-md border-0 py-1 text-neutral-900 shadow-sm ring-1 ring-inset ring-neutral-300 placeholder:text-neutral-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm/6 dark:bg-neutral-900 dark:text-neutral-200 dark:ring-neutral-700 dark:focus:ring-primary-500"
...
import { getContrast, hexToTailwindColor } from '@/Core/utils'
