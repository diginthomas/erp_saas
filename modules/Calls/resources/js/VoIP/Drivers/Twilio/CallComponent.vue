      ...
      <div class="grow">
        <div class="flex items-center space-x-4">
          ...
          <IBadge
            ...
            variant="info"
          >
            <Icon icon="Clock" class="mr-1 size-4 text-current" />
      ...
      >
        ...
        >
          <template #label="{ label }">
            <div class="flex items-center">
              <Icon icon="Megaphone" class="mr-1 size-5" />
        ...
        >
          <template #label="{ label }">
            <div class="flex items-center">
              <Icon icon="Microphone" class="mr-1 size-5" />
              {{ strTruncate(label ? label : '', 25) }}
            </div>
          </template>
        </IDropdownSelect>
        ...
        <ILink
          :text="$t('calls::call.unknown_devices')"
