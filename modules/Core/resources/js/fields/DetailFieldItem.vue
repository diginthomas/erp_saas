<template>
  ...
  >
    ...
    <div class="grid grid-cols-3 gap-4">
      <div
        :class="[
          'col-span-1 max-w-full justify-self-end truncate text-right text-sm  hover:max-w-none hover:overflow-visible hover:whitespace-normal ',
          isRequiredAndMissingValue
            ? 'text-danger-800'
      ...
      <div
        :class="[
          'col-span-2 break-words text-sm',
          isRequiredAndMissingValue
            ? 'text-danger-700'
