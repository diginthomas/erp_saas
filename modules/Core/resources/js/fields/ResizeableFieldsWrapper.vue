<template>
  <div
    ...
    :class="[
      isResizeable
        ? 'resize-y [&::-webkit-resizer]:rounded-tl [&::-webkit-resizer]:bg-neutral-50 [&::-webkit-resizer]:outline [&::-webkit-resizer]:outline-1 [&::-webkit-resizer]:outline-neutral-200 [&::-webkit-resizer]:dark:bg-neutral-800 [&::-webkit-resizer]:dark:outline-neutral-700'
        : '',
