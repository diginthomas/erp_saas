              ...
              <div class="flex items-center">
                <div class="shrink-0">
                  <icon
                    ...
                    icon="CheckCircle"
                    class="size-5 text-success-400"
                  />

                  <icon
                    v-if="notification.type === 'info'"
                    icon="InformationCircle"
                    class="size-5 text-info-400"
                  />

                  <icon
                    v-if="notification.type === 'error'"
                    icon="XCircle"
                    class="size-5 text-danger-400"
                  />
                </div>
                ...
                <div class="ml-3 flex w-0 flex-1 justify-between">
                  ...
                  <button
                    ...
                    type="button"
                    class="ml-3 shrink-0 rounded-md bg-white text-sm font-medium text-primary-600 hover:text-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
