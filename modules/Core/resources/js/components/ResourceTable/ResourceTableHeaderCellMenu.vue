<template>
  ...
  >
    <div
      class="w-56 divide-y divide-neutral-200 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-neutral-200 dark:divide-neutral-700 dark:bg-neutral-800 dark:ring-neutral-700"
    >
      <div class="px-4 py-2">
        <p
      ...
      <div v-if="isSortable" class="px-1.5 py-2">
        <div class="flex flex-col space-y-1">
          <ILink
            variant="neutral"
            class="flex items-center rounded-md p-1 px-2 text-sm text-neutral-700 hover:bg-neutral-100 hover:text-neutral-900 dark:text-white dark:hover:bg-neutral-700"
            plain
      ...
      <div v-if="!isPrimary && customizeable" class="px-1.5 py-2">
        <div class="flex flex-col space-y-1">
          <ILink
            variant="neutral"
            class="flex items-center rounded-md p-1 px-2 text-sm text-neutral-700 hover:bg-neutral-100 hover:text-neutral-900 dark:text-white dark:hover:bg-neutral-700"
      ...
      <div v-if="customizeable">
        <div class="-ml-px px-4 py-2">
          <IFormCheckbox
            :label="$t('core::table.wrap_column')"
            :checked="wrap"
