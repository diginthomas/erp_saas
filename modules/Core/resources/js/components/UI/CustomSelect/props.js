...
export default {
  ...
  /**
   * Defines the size of the select component. Acceptable values are 'sm'
   * (small), 'md' (medium), 'lg' (large), an empty string, or false. It
   * controls the overall dimensions of the select box.
   *
   * @type {String|Boolean}
   * @default 'md'
   */
