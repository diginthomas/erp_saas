    ...
    <div v-show="!edit" class="flex items-center space-x-4">
      ...
      <div class="flex space-x-2">
        <FileUpload
          ...
          class="!flex cursor-pointer items-center rounded-full bg-primary-50 px-4 py-1.5 text-sm font-medium text-primary-800 hover:bg-primary-100 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-offset-2 focus:ring-offset-primary-50"
