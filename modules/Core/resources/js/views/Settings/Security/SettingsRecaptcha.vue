<template>
  <form @submit.prevent="saveReCaptchaSettings">
    ...
    >
      ...
      <div
        class="mt-4 rounded-lg border border-primary-100 bg-gradient-to-tr from-primary-50/40 from-25% to-primary-100 px-10 py-6 md:flex md:items-center dark:border-neutral-800 dark:bg-gradient-to-tl dark:from-neutral-600 dark:to-neutral-900"
      >
        <svg
        ...
        <div class="mt-5 md:ml-8 md:mt-0">
          ...
          <p
            ...
            class="text-primary-700 md:max-w-xl dark:text-neutral-300"
          />
        </div>
      </div>
