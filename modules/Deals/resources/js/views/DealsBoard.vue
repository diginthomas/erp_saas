<template>
  <MainLayout no-padding :overlay="isLoading">
    ...
    <BaseBoard :board-id="resourceName" board-class="deals-board">
      <template #top>
        <div class="sm:flex sm:flex-wrap">
          ...
          <div
            ...
            class="ml-0 mt-1 flex content-center space-x-1 sm:ml-2 sm:mt-0 sm:w-auto sm:flex-row"
          >
            <FiltersDropdown
...
watch(activePipeline, newPipeline => {
  lastUsedPipeline.value = newPipeline.id
  fetchAsNew()
})
