<template>
  <nav aria-label="Progress">
    <ol
      class="divide-y divide-neutral-300 overflow-hidden rounded-md border border-neutral-300 lg:flex lg:flex-wrap lg:divide-y-0 dark:divide-neutral-600 dark:border-neutral-600"
    >
      <PipelineStage
