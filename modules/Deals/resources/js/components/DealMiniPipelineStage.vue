<template>
  <li
    class="relative overflow-hidden truncate bg-neutral-50 lg:flex lg:flex-1 dark:bg-neutral-800"
  >
    ...
    <template v-if="index !== totalStages - 1">
      ...
      <div
        class="absolute right-0 top-0 hidden h-full w-5 bg-neutral-50 lg:block dark:bg-neutral-800"
        aria-hidden="true"
      >
        <svg
