<template>
  <div>
    <h3
      class="mb-3 inline-flex items-center text-base/6 font-semibold text-neutral-700 dark:text-neutral-100"
    >
      Share via link
      <IButtonCopy
    ...
    <h3
      class="mb-3 mt-8 text-base/6 font-semibold text-neutral-700 dark:text-neutral-100"
    >
