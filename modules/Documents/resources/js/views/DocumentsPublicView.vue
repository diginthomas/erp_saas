...
<template>
  <div class="h-full max-h-full w-full bg-white">
    <component :is="navigationComponent" v-bind="navigationComponentAttributes">
      <template #actions>
        ...
        >
          <div class="inline-flex items-center">
            <Icon icon="DocumentDownload" class="size-4 sm:mr-2" />
      ...
      <template #content>
        <IAlert v-if="$route.query.accepted" class="mb-6" variant="success">
          <div v-html="acceptThankYouMessage"></div>
        </IAlert>

        <IAlert v-else-if="$route.query.signed" class="mb-6" variant="success">
          <div v-html="signThankYouMessage"></div>
        </IAlert>
    ...
    <IModal
      ...
      @submit="sign"
    >
      <div v-show="!signerVerified" class="pb-3">
        <div class="flex justify-center rounded-md shadow-sm">
          ...
          <IButton
            ...
            :disabled="!form.email || signerVerificationInProgress"
      ...
      <IAlert
        v-if="signerVerificationFailed"
        variant="warning"
        class="mt-3"
        :text="$t('documents::document.signature.verification_failed')"
      />
      ...
      >
        <IFormInput
          ...
          class="font-signature text-[1.4rem]"
        />
      ...
      <p
        v-show="signerVerified"
        class="mb-3 text-sm text-neutral-500"
        v-text="
          signatureBoundText
