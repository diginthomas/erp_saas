          ...
          <template #top>
            ...
            >
              ...
              >
                ...
                <template #footer>
                  <ILink
                    class="block border-t border-neutral-200 px-4 py-2 hover:bg-neutral-50 dark:border-neutral-600 dark:hover:bg-neutral-700"
                    @click="
...
const { setting, currentUser } = useApp()
