  ...
  <div v-show="visible" class="mx-auto max-w-6xl">
    <div class="mb-8 flex justify-end space-x-2 text-right">
      ...
      <IButtonIcon
        ...
        class="mr-2 mt-1 shrink-0 self-start"
      ...
      <div class="relative w-72">
        ...
        <a
          ...
          href="#"
          class="absolute right-10 top-2 text-neutral-400 hover:text-neutral-600 focus:outline-none"
    ...
    >
      ...
      <div class="grid auto-cols-max grid-flow-col gap-4">
        ...
        <span
          ...
          class="mt-2.5"
        >
          <Icon icon="QuestionMarkCircle" class="size-5" />
        </span>
      </div>
    ...
    <div class="mt-10">
      <IAlert
        v-if="displayPlaceholdersMessage"
        class="mb-4"
        :text="$t('documents::document.placeholders_replacement_info')"
      />
...
import IAlert from '@/Core/components/UI/Alert/IAlert.vue'
